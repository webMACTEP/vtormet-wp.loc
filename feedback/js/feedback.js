...
$(document).ready(function () {
    ...
    var touch = $('#menu-button2, #menu-button3');
    var menu = $('.test');
...
$(document).ready(function () {
    ...
    var touch = $('#touch-menu, #touch-menu3');
    var menu = $('.sidebar_main');
                ...
                if (isset(cfg.notify) && !/none/i.test(cfg.notify)) {
                    ...
                    if (/textbox/i.test(cfg.notify)) {
                        ...
                        if (isset(answer.errors)) {
                            ...
                            $('.modals__01, .modals__02').removeClass('open');
                            $('.modals__body').addClass('h230');
                            $('.modals__body').removeClass('h400, h600');
                            $('.modals, .modals__03').addClass('open');
