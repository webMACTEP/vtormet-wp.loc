         ...
         <div class="entry-content">
            <div class="about-wrapper">
               <div class="price-dashboard">
                  <!-- <div class="price-dashboard__share">Поделится:
                     <a href=""> <img src="<?php echo vm_get_image('share01.svg') ?>" alt=""></a>
                     <a href=""> <img src="<?php echo vm_get_image('share02.svg') ?>" alt=""></a>
                     <a href=""> <img src="<?php echo vm_get_image('share03.svg') ?>" alt=""></a>
                     <a href=""> <img src="<?php echo vm_get_image('share04.svg') ?>" alt=""></a>
                     <a href=""> <img src="<?php echo vm_get_image('share05.svg') ?>" alt=""></a>
                     <a href=""> <img src="<?php echo vm_get_image('share06.svg') ?>" alt=""></a>
                  </div> -->
